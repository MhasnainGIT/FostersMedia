  ...
  return (
    <div className="min-h-screen bg-[#08090C] flex items-center justify-center relative overflow-hidden px-6 bg-mesh-grid text-white">
      ...
      >
        ...
        <div className="glass-panel p-8 border-white/5 shadow-2xl relative overflow-hidden bg-[#0E1015]/80 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="admin@fostersmedia.com"
                  {...register("email")}
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className="text-white/40 hover:text-white transition-colors cursor-help font-mono">
                Code: password123
              </span>
            </div>
        ...
        <div className="text-center mt-6 text-[10px] text-white/30 font-mono">
          SECURE IP LINKED LAYER • Fosters control gateway v1.0
        </div>
      </motion.div>
    </div>
  );
